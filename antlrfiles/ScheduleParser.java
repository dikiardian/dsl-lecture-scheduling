...
public class ScheduleParser extends Parser {
	...
	public static class ScheduleContext extends ParserRuleContext {
		public TerminalNode OPERATOR() { return getToken(ScheduleParser.OPERATOR, 0); }
		public List<TerminalNode> OPERAND() { return getTokens(ScheduleParser.OPERAND); }
		public TerminalNode OPERAND(int i) {
			return getToken(ScheduleParser.OPERAND, i);
		}
